...
Function BaseNameFromEDID(baseFile: IInterface; grup: string; editorID: string): string;
var
  mainRecord: IInterface;
begin
  mainRecord := MainRecordByEditorID(GroupBySignature(baseFile, grup), editorID);
  Result := BaseName(mainRecord)
end;
